...
var _default = {
  ...
  methods: {
    onDeleteClick: function onDeleteClick() {
      ...
      this.$store.commit('deleteItem', this.itemIndex);
    }
  }
};
exports.default = _default;
        var $30eb9e = exports.default || module.exports;
      
      if (typeof $30eb9e === 'function') {
        $30eb9e = $30eb9e.options;
      }
    
        /* template */
        Object.assign($30eb9e, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$30eb9e', $30eb9e);
          } else {
            api.reload('$30eb9e', $30eb9e);
          }
        }
...
var _default = {
  ...
  methods: {
    ...
    addTodo: function addTodo() {
      ...
      this.$store.commit('addItem', this.addInput);
      this.addInput = '';
    },
    ...
    //이 함수가 실행되면 위에 template에 있는 count값이 바뀐다.
  ...
  //Ram안에서 가상으로 생성 되었을때! vue가 가상으로 html을 만드는 과정
  created: function created() {
    console.log("created!");
  },
  //가상으로 생성된 컴포넌트가 실제로 삽입되었을 때, vue가 내부적으로 자바스크립트로 html을 만들어서 이게되면 화면에보여준다.
  mounted: function mounted() {
    console.log("mounted!");
  }
};
exports.default = _default;
        var $5e9241 = exports.default || module.exports;
      
      if (typeof $5e9241 === 'function') {
        $5e9241 = $5e9241.options;
      }
    
        /* template */
        Object.assign($5e9241, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("div", { staticClass: "add" }, [
      ...
      _vm._v(" "),
      _c("div", { class: _vm.abc }),
      _vm._v("\n    " + _vm._s(_vm.greeting) + _vm._s(_vm.count) + "\n    "),
      _c("div", [
        _c("input", {
          directives: [
            {
        ...
        _vm._v(" "),
        _c("button", { on: { click: _vm.addCount } }, [_vm._v("add")])
      ]),
      _vm._v(" "),
      _c("button", { on: { click: _vm.toggleMenu } }, [_vm._v("메뉴")]),
      _vm._v(" "),
      _vm.isMenuShow
        ? _c(
            "div",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5e9241', $5e9241);
          } else {
            api.reload('$5e9241', $5e9241);
          }
        }
...
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"App.vue","./store.js":"store.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
